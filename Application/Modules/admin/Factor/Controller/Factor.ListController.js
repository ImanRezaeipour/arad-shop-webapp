              ...
              parse: function (value) {
                ...
                if (value != undefined) {
                  if (typeof value === 'string') {
                    ...
                    var c = angular.copy(value.split('/'));
                    ...
                    var ml = k[0] + "/" + k[1] + "/" + k[2];
                    var ka = moment(ml).format('YYYY-MM-DDTHH:mm:ss');
                    console.log(ka);
                    return new Date(ka);
                  }
...
controller.$inject = ["$scope", "$state", "admin.FactorService", "toastr"];
angular.module('admin.FactorApp').controller('admin.Factor.ListController', controller)