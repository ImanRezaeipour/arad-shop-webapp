...
getOrgChart.themes = {
    annabel: {
        ...
        text: '<text width="[width]" class="get-text get-text-[index]" x="400" y="120">[text]</text>',
    ...
    cassandra: {
        ...
        text: '<text width="[width]" class="get-text get-text-[index] get-cassandra-text" x="400" y="120">[text]</text>',
    ...
    lena: {
        ...
        text: '<text transform="rotate(-8)" width="[width]" class="get-text get-text-[index]" x="400" y="120">[text]</text>',
    ...
    helen: {
        ...
        expandCollapseBtnRadius: 20,
        text: '<text transform="rotate([rotate])"  width="[width]" class="get-text get-text-[index] get-helen-text" x="400" y="120">[text]</text>',
